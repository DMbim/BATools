...
namespace BA.UI.KeyplanGrid
{
    public partial class KeyplanGridWindow : Window
    {
        ...
        public KeyplanGridWindow(Document doc, KeyplanGridViewModel vm)
        {
            ...
            _vm.PropertyChanged += (s, e) =>
            {
                ...
                if (e.PropertyName == nameof(KeyplanGridViewModel.ActiveZoneSession) ||
                    ...
                    e.PropertyName == nameof(KeyplanGridViewModel.CanCommitZoneLabels))
        ...
        private void UpdateZoneButtonVisibility()
        {
            ...
            bool canCommit = active && _vm.CanCommitZoneLabels;
            ...
            if (BtnCommitZoneLabels != null) BtnCommitZoneLabels.IsEnabled = canCommit;
