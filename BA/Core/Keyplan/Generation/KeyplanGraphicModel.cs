...
namespace BA.UI.KeyplanGrid
{
    public sealed class KeyplanGraphicModel
    {
        ...
        public ElementId ZoneTagElementId { get; set; } = ElementId.InvalidElementId;
    ...
    public sealed class GeneratedElementRecord
    {
        ...
        /// <summary>
        /// ElementId of the IndependentTag created for this region's zone label,
        /// if any. ElementId.InvalidElementId if no tag has been created.
        /// Tracked so CommitZoneLabels can delete the old tag before creating a
        /// new one on re-label.
        /// </summary>
        public ElementId ZoneTagElementId { get; set; } = ElementId.InvalidElementId;
    }
