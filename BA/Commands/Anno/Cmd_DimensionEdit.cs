...
{
    /// <summary>
    /// Default action when clicking the Dim pulldown header.
    /// Currently: same behavior as "Override text".
    /// </summary>
    [Transaction(TransactionMode.Manual)]
    public class Cmd_DimensionEdit : ExternalCommand
    {
        public override void Execute()
        {
            ...
            try
            {
                ...
                var dialog = new InputTextDialog(
                    "Enter text to place below the dimension value:",
